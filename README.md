...
- **Themes** — dropdown in the upper right with 7 themes (Light, Dark, Midnight, Forest, Synthwave, Solarized, Sepia); defaults to Dark, preference saved in `localStorage`. Charts adapt their axis/grid colors per theme
...
- **Themes** — dropdown in the upper right with 7 themes (Light, Dark, Midnight, Forest, Synthwave, Solarized, Sepia); defaults to Dark, preference saved in `localStorage` and shared with the portfolio page
