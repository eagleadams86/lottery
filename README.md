...
- **Keyboard and screen-reader landmarks** — a skip link straight to the content, and real `main` and `footer` regions to jump between. The skip link lands the content just below the header bar whatever height the bar is at that moment — on a phone held upright the bar is two lines of name and a line of controls, and until 2026-09-14 the content landed under it
